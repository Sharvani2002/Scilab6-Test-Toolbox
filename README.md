...
- To get thirdparty folder:
  ...
  - Enter the location of this folder on the terminal and run the commands `chmod +x *` and  `./run.sh` to create and copy the "libtrans.so" and "trans.h" files to the "thirdparty" folder.
